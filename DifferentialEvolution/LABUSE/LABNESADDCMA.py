...
def main():
    ...
    with tf.Session() as sess:
        ...
        noise = tf.gather(noiseP, good_images)
        ...
        def get_grad(pt,InitImg,TargetImg,TargetClass,Labels,lower,upper,should_calc_truth=False):
            global UnVaildExist
            ...
            for _ in range(num_batches):
                ...
                logitsnp,loss, dl_dx_ = sess.run([logits,finallosses, grad_estimate], feed_dict)
        ...
        for p in range(16,100):
            ...
            for i in range(max_iters):
                ...
                prev_g = g
                l, g,mnoise,stnoise = get_grad(adv,InitImg,TargetImg,TargetClass,Labels,lower,upper)
